 ...
 * window's backgroundColor (#121211, Graphite page) and brand accent inline.
 * Shown immediately, closed once the main window is ready.
 */

const SPLASH_HTML = `<!doctype html><html><head><meta charset="utf-8"><style>
  html,body{margin:0;height:100%;background:#121211;overflow:hidden}
  .wrap{height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;
    font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#F4F3F0}
  .ring{width:26px;height:26px;border-radius:50%;
    border:2px solid rgba(255,255,255,.14);border-top-color:#D86A49;animation:spin .8s linear infinite}
  .title{font-size:19px;font-weight:600;letter-spacing:.01em}
  .sub{font-size:12px;color:#7E7C75}
