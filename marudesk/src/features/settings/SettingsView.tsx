...
export function SettingsView() {
  ...
  // @container goes on the outer wrapper, not the flex row itself: a
  // container-query variant resolves against the nearest *ancestor* container,
  // so an element can never react to its own container-type. With the variants
  // on a descendant they finally match this surface's width and the sidebar +
  // content lay out side-by-side instead of stacking (categories over body).
  return (
    <div className="flex-1 min-h-0 flex @container">
      <div className="flex-1 min-w-0 min-h-0 flex bg-surface-page flex-col @[20rem]:flex-row">
